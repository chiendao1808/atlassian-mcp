...
Subagents are defined in [`.claude/agents/`](./agents/) and spawned via the Task tool with `subagent_type`. See [`CLAUDE.md`](../CLAUDE.md) for the agent catalog and core boundaries.
