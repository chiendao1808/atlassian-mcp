...
Confluence V1 tools are read/search only after authentication. Jira includes both read and mutation tools; Jira mutation tools should be routed through client approval where available.
